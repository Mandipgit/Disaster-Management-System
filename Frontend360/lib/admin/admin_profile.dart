...
class _AdminProfileScreenState extends State<AdminProfileScreen>
  ...
  // ── Admin editable data ────────────────────────────────────────────────────
  String _name = 'Rajesh Kumar';
  String _initials = 'RK';
  String _email = 'rajesh.admin@disaster360.gov.np';
  String _phone = '+977  98XXXXXXXX';
  String _employeeId = 'ADM-2024-001';
  String _department = 'Disaster Management Authority';
  String _jurisdiction = 'Sunsari District';
  bool _systemOnline = true;

  late TabController _tabController;

  final int _alertsManaged = 47;
  final int _reportsReviewed = 312;
  final int _teamsDeployed = 8;
  final int _zonesMonitored = 15;
  ...
  final List<_AppUser> _admins = [
    _AppUser(
      ...
      loginTime: 'Today, 8:02 AM',
      citizenId: 'ADM-2024-001',
      isOnline: true,
      district: 'Sunsari',
    ),
    _AppUser(
    ...
    _AppUser(
      ...
      loginTime: 'Yesterday, 5 PM',
      citizenId: 'ADM-2024-003',
      isOnline: false,
      district: 'Itahari',
    ),
    _AppUser(
      ...
      loginTime: 'Today, 7:45 AM',
      citizenId: 'ADM-2024-004',
      isOnline: true,
      district: 'Biratnagar',
    ),
    _AppUser(
      ...
      loginTime: 'Mar 28, 3 PM',
      citizenId: 'ADM-2024-005',
      isOnline: false,
      district: 'Morang',
    ),
  ];
  ...
  final List<_AppUser> _citizens = [
    _AppUser(
      ...
      loginTime: 'Today, 10:22 AM',
      citizenId: '12-34-56-78901',
      isOnline: true,
      district: 'Ward 5, Dharan',
    ),
    _AppUser(
      id: 'CIT-002',
      name: 'Sita Rai',
      ...
      loginTime: 'Today, 9:05 AM',
      citizenId: '12-34-56-78902',
      isOnline: true,
      district: 'Itahari, Ward 3',
    ),
    _AppUser(
      id: 'CIT-003',
      name: 'Rajan Thapa',
      ...
      loginTime: 'Today, 8:50 AM',
      citizenId: '12-34-56-78903',
      isOnline: false,
      district: 'Ward 5, Dharan',
    ),
    _AppUser(
      ...
      loginTime: 'Yesterday, 7 PM',
      citizenId: '12-34-56-78904',
      isOnline: false,
      district: 'Itahari',
    ),
    _AppUser(
      ...
      loginTime: 'Today, 11:00 AM',
      citizenId: '12-34-56-78905',
      isOnline: true,
      district: 'Biratnagar Hwy',
    ),
    _AppUser(
      id: 'CIT-006',
      name: 'Binod Limbu',
      ...
      loginTime: 'Today, 10:45 AM',
      citizenId: '12-34-56-78906',
      isOnline: true,
      district: 'Bhedetar',
    ),
    _AppUser(
      ...
      loginTime: 'Mar 28, 6 PM',
      citizenId: '12-34-56-78907',
      isOnline: false,
      district: 'Dharan-7',
    ),
    _AppUser(
      ...
      loginTime: 'Today, 9:30 AM',
      citizenId: '12-34-56-78908',
      isOnline: true,
      district: 'Sunsari',
    ),
  ];
  ...
  final List<_AppUser> _rescueTeams = [
    ...
    _AppUser(
      ...
      loginTime: 'Today, 7:15 AM',
      citizenId: 'RSC-T002',
      isOnline: true,
      district: 'Itahari Base',
    ),
    _AppUser(
      id: 'RSC-003',
      name: 'Team Charlie',
    ...
    _AppUser(
      ...
      name: 'Team Foxtrot',
      role: 'Rescue Team',
      phone: '+977 9811000006',
      loginTime: 'Today, 9:00 AM',
      citizenId: 'RSC-T006',
      isOnline: false,
      district: 'Dhankuta',
    ),
  ...
  void _showEditDialog(BuildContext context) {
    ...
    final jurisdCtrl = TextEditingController(text: _jurisdiction);
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _DialogField(controller: deptCtrl, label: 'Department'),
                    const SizedBox(height: 12),
                    _DialogField(controller: jurisdCtrl, label: 'Jurisdiction'),
                  ],
                ),
              ),
            ),
                  ...
                  setState(() {
                    ...
                    _department =
                        deptCtrl.text.trim().isNotEmpty
                            ...
                            : _department;
                    _jurisdiction =
                        jurisdCtrl.text.trim().isNotEmpty
                            ? jurisdCtrl.text.trim()
                            : _jurisdiction;
